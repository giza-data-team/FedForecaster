...
class MetaFeatureExtractionAggregator(Aggregator):
    ...
    def aggregate(self, parameters, data_sizes=[], dataset_name=None, num_clients=None):
        ...
        for feature, feature_parameters in parameters.items():
            ...
            # out_parameters[feature]["dataset_name"] = dataset_name
            out_parameters[feature]["num_clients"] = int(num_clients)
